 ...
 */
class getTipoMesaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoMesaRepository' shared autowired service.
     *
     * @return \App\Repository\TipoMesaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoMesaRepository.php';

        return $container->privates['App\\Repository\\TipoMesaRepository'] = new \App\Repository\TipoMesaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
