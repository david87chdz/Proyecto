...
class getMesaRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\MesaRepository'])) {
            return $container->privates['App\\Repository\\MesaRepository'];
        }

        return $container->privates['App\\Repository\\MesaRepository'] = new \App\Repository\MesaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
